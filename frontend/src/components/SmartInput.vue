    ...
    <div class="relative group">
      ...
      <div class="flex rounded-md shadow-sm bg-gray-800 rounded-full">
        <div class="relative flex flex-grow items-stretch focus-within:z-10">
          <input @keydown.space="extractSyntax()" @keydown.enter="currentlyEditedTask ? updateTask() : !isSearching ? createTask() : searchTasks()" v-model="userInput" ref="smartInput" type="text" name="smart" id="smart" class="block w-full rounded-none rounded-l-full border-gray-700 border-r-0 bg-gray-800 text-gray-50 placeholder-gray-500 pl-5 focus:outline-none focus:ring-0 focus:border-gray-700 focus:border-r-0" placeholder="Write down your latest burden or ignore it. #pointless !3 due:today" />
        </div>
