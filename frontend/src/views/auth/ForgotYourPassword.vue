<template>
  <div class="relative isolate overflow-hidden bg-gray-900 min-h-screen flex items-center">
    ...
    <div class="mx-auto px-6 max-w-lg w-full pt-10 pb-24 sm:pb-32 flex flex-col lg:py-40 lg:px-8 items-center">
      <div>
        <Logo />
      </div>
      <div class="text-5xl text-gray-50 mt-12 leading-normal">
        Password retrieval? Not in this lifetime.
      </div>
    </div>
  </div>
</template>
